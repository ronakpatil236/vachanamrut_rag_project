...
Below are the benchmark comparisons generated by our `gemini-1.5-flash` LLM-as-a-Judge evaluation framework:

### Dense Retrieval Scorecard
![Dense Retrieval Scorecard](results/scorecard_dense.png)

### Hybrid Retrieval Scorecard
![Hybrid Retrieval Scorecard](results/scorecard_hybrid.png)

### Query Transformed Retrieval Scorecard
![Query Transformed Scorecard](results/scorecard_transformed.png)
